...
// 2. Run: GOOGLE_APPLICATION_CREDENTIALS=path/to/key.json npx ts-node scripts/seed-content.ts
// Or if using Firebase emulator:
// 3. Run: FIRESTORE_EMULATOR_HOST=localhost:8080 npx ts-node scripts/seed-content.ts
